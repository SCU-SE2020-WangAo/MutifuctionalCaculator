...
class ShadePanel3 extends JPanel {
...
//                + "Email: thexjx@outlook.com
        JTextArea J1 = new JTextArea("Hey, I know your concern about Matrix.");
        ...
        JLabel J2 = new JLabel("Welcome to the");
        J2.setBounds(10, 155, 200, 30);
        J2.setFont(f2);
        shadePanel.add(J2);

        JLabel MyGithub_Label = new JLabel( "Matrix Calculator!");
...
class InternetMonitor3 extends MouseAdapter{
