...
public class copyrights2 extends JDialog {
    ...
    copyrights copy=copyrights.getSingletonInstance();
    String s1=copy.getName();
    String s2=copy.getQQ();
    String s3=copy.getTelephone();
    String s4= copy.getMessage();
    public copyrights2() {
