...
public class AboutInfo2 extends JDialog {
    ...
    AboutInfo aboutinfo=AboutInfo.getSingletonInstance();
    String s1=aboutinfo.getName();
    String s2=aboutinfo.getQQ();
    String s3=aboutinfo.getTelephone();
    String s4= aboutinfo.getMessage();
    public AboutInfo2() {
        setTitle("版权声明");//设置窗体标题
        ...
        JTextArea J1 = new JTextArea("Name:"+s1);
        ...
        JLabel J2 = new JLabel(s4);
        J2.setBounds(10, 145, 200, 30);
        J2.setFont(f2);
        shadePanel.add(J2);

        JLabel MyGithub_Label = new JLabel("QQ:"+s2);
//        Github:
        MyGithub_Label.setFont(f2);
        final JLabel MyGithub = new JLabel("telephone"+s3);
//        https://github.com/JiaxinTse
        MyGithub.setFont(f2);
...
//        http://www.cnblogs.com/journal-of-xjx
        MyCnBlog.setFont(f2);
...
class InternetMonitor2 extends MouseAdapter{
